...
class FunctionBlockWithSourcesAndSinks extends DelegatingList<XmlElement> {
  ...
  factory FunctionBlockWithSourcesAndSinks(
    ...
    var inIds = <String, int>{
      _enableIn: currentConnectionPointId++,
    ...
    var outIds = <String, int>{
      _enableOut: currentConnectionPointId++,
      for (var inOut in inOuts)
        inOut.functionVariableName: currentConnectionPointId++,
      for (var out in outs)
      ...
      FunctionBlockDataObject(
        ...
        [
          ...
          InputVariables([
            InputVariable(
              name: _enableIn,
              connectionPointInRef: inIds[_enableIn]!,
          ...
          OutputVariables([
            OutputVariable(
              name: _enableOut,
              connectionPointOutRef: outIds[_enableOut]!,
    ...
    return FunctionBlockWithSourcesAndSinks._(elements, outIds[_enableOut]!);
  }
}
